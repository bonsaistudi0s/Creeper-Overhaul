...
public class FabricAttributes {
    ...
    public static void register() {
        Registry.register(Registry.ATTRIBUTE, new ResourceLocation(Creepers.MODID, "reach_distance"), REACH_DISTANCE);
        Registry.register(Registry.ATTRIBUTE, new ResourceLocation(Creepers.MODID, "swim_speed"), SWIM_SPEED);
    }
}
